...
int main(void)
{
	...
	for(int i=0;i<K;++i){
		cin >> list_rect[i].first.first >> list_rect[i].first.second; 	// ÁÂÇÏ ²ÀÁþÁ¡ 
		cin >> list_rect[i].second.first >> list_rect[i].second.second; // ¿ì»ó ²ÀÁþÁ¡ 
	}
//	/* Debugging */
//	for(int i=0;i<K;++i){
//		cout << list_rect[i].first.first << ' ' << list_rect[i].first.second << ' '; 	// ÁÂÇÏ ²ÀÁþÁ¡ 
//		cout << list_rect[i].second.first << ' ' << list_rect[i].second.second << endl; // ¿ì»ó ²ÀÁþÁ¡ 
//	}
